        ...
        <div style={{display: "flex", flexDirection: "column"}}>
          {oldQuestion.map((prompt, index) => (
            ...
            onClick={() => handleReplaceValue(prompt)}
              key={index}
              className="my-2 inline text-[#878FA1] text-sm font-medium w-fit p-1 sm:p-2 border-[1px] border-white rounded-lg hover:border-white hover:text-gray-100 hover:cursor-pointer transition-all"
            >
