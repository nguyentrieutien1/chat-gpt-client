  ...
  return (
    <>
      <div className="flex flex-col items-center">
        <div className="max-w-[280px] grid grid-cols-2 gap-1 p-1 rounded-full border-[1px] border-white">
          <div
            className={`${
              option === "advance"
                ? "bg-gradient-to-r from-[#5143a2] to-[#0e8bff] rounded-full "
                : "text-[#878fad] hover:text-white"
            } flex flex-col px-4 py-1 hover:cursor-pointer text-center transition-all`}
            onClick={() => setOption("advance")}
          >
            <p className="flex items-center justify-center gap-1 text-lg font-medium text-white">
              <IoDiamondOutline size={15} /> Advanced
            </p>
