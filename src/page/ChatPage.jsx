...
const ChatPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    window.scrollTo({ behavior: 'smooth', top:chatContainerRef.current?.offsetTop })
  ...
  return (
    <div id="form_chat" className="relative h-full w-[90%] mx-auto">
      <div
        className=" max-h-[580px] xl:max-h-[590px]" style={{overflowY: "scroll"}}
      >
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <form
          ...
          className="relative pt-3 bg-[#121521] fixed w-full"
        >
          <input
            max={500}
